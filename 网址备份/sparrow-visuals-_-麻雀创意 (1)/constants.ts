...
const getPaddedVideoUrl = (index) => {
  const num = index.toString().padStart(3, '0');
  // For the first video, use the optimized Cloudinary version
  if (index === 1) return 'https://res.cloudinary.com/dfsa4xnkh/video/upload/f_auto,q_auto/v1766679730/video001_manhfw.mp4';
  return `${GITHUB_VIDEO_BASE}/video${num}.mp4`;
};

// Helper to generate Optimized Unsplash URLs
export const getUnsplashUrl = (url, width = 2000, quality = 80, blur = 0) => {
...
export const GLOBAL_ASSETS = {
  // Using Cloudinary URL as requested for optimized video delivery
  HERO_VIDEO: 'https://res.cloudinary.com/dfsa4xnkh/video/upload/f_auto,q_auto/v1766679730/video001_manhfw.mp4',
...
export const PROJECTS = [
  {
    id: '01',
    title: '911 GTS: AN AI-DRIVEN REIMAGINATION',
    category: 'AIGC / Automotive / Visual R&D',
    ...
    description: 'More than a visualization, this project is a digital deconstruction of the 911 GTS soul. Leveraging the generative power of AI, we’ve moved beyond traditional rendering to simulate cinematic tension and fluid dynamics through large-scale diffusion models. It is a new paradigm of creation: Driven by dreams, executed by intelligence.',
    credits: [
  ...
  },
  {
    ...
    year: '2023',
    coverImage: 'https://images.unsplash.com/photo-1617791160505-6f00504e35d9?q=80&w=2070&auto=format&fit=crop',
